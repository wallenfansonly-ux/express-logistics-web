  ...
  if (loading) {
    return (
      <div className="shipment-form-page">
        <LoadingSpinner size="large" message="Creating shipment..." />
      </div>
    );
  }
      ...
      <form className="shipment-form" onSubmit={handleSubmit}>
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              <label htmlFor="courier">{t.shipment.courier}</label>
              <select id="courier" name="courier" value={formData.courier} onChange={handleChange}>
                <option value="express-logistics">Express Logistics</option>
                <option value="partner-a">Partner Carrier A</option>
                <option value="partner-b">Partner Carrier B</option>
              </select>
            </div>
          </div>
        </div>
